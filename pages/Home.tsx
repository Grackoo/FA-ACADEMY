...
const DebtVsInvestmentTool = () => {
  ...
  return (
    <section className="py-24 bg-transparent relative overflow-hidden border-t border-slate-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* Panel de Entradas */}
          <div className="lg:col-span-1 bg-slate-900 border border-slate-800 p-6 rounded-3xl shadow-xl z-10">
            ...
            <div className="space-y-6">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-slate-800 text-white border border-slate-700 rounded-xl px-4 py-3 focus:border-amber-400 outline-none transition-all"
                />
              </div>
          ...
          <div className="lg:col-span-2 space-y-6 z-10">
            ...
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 border border-amber-400/30 p-8 rounded-3xl shadow-2xl relative">
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <button 
                  ...
                  className="bg-amber-400 hover:bg-amber-300 text-slate-950 font-bold px-8 py-4 rounded-2xl flex items-center gap-3 transition-all whitespace-nowrap shadow-lg shadow-amber-400/20"
                >
                  Cambiar mi realidad
...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-transparent">
      ...
      {/* 5.5 Debt vs Investment Calculator */}
